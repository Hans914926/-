...
int main(){
	...
	double P[2*n]={0};
	int rank;
	int rounds_max[n+1][n+1];//虫初程ㄓ初计 
	int rounds_best[n+1][n+1];//程ㄎㄓ初计 
	int rounds_again[n+1][n+1][2];//癹伴禲ㄓ初计(0㎝rounds_max) 
	int max=1;//﹍程ㄓ初计 
	double E=0;
	double E_num=0;
	double E_den=0;
